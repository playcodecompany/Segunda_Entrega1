    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('home') }}">
                <img src="{{ asset('imagenes/logo.jpg') }}" alt="Logo" style="max-height: 50px;" />
            ...
            <div class="collapse navbar-collapse justify-content-end" id="menuNav">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('juego') ? 'active' : '' }}" href="{{ route('jugar') }}">Jugar</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('iniciosesion') ? 'active' : '' }}" href="{{ route('iniciosesion') }}">Iniciar Sesión</a>
                    </li>
                    <li class="nav-item">
...
function cambiarIdioma(lang) {
    if (lang === "en") {
        alert("Versión en inglés no disponible todavía");
    } else {
